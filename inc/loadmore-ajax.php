...
class Moiety_Render_Posts_Ajax{
    ...
    public function render_posts_ajax_loadmore(){    
        ...
        if( isset($_POST['nonce']) && 
            ...
            $function_name = 'moiety_'.$post_type . '_template';
...
add_action( 'wp_ajax_nopriv_custom_render_posts_ajax_loadmore', [ new Moiety_Render_Posts_Ajax() , 'render_posts_ajax_loadmore'] );
add_action( 'wp_ajax_custom_render_posts_ajax_loadmore',[ new Moiety_Render_Posts_Ajax() , 'render_posts_ajax_loadmore'] );
?>