...
function activeBtn(e) {
    e.classList.remove("loading-state"), e.removeAttribute("disabled")
}

function disableBtn(e) {
    e.classList.add("loading-state"), e.setAttribute("disabled", "disabled")
}
...
function isInArray(e, t) {
...
}("undefined" != typeof window ? window : void 0, function (w, e) {
    function g(e) {
    ...
    S.fn = S.prototype = {
        ...
        var e, t, n, i, o, r, s = arguments[0] || {},
            ...
            l = arguments.length,
            c = !1;
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" === _typeof(s) || _(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
    ...
    var p = function (n) {
        ...
        var e, f, b, r, s, p, d, g, E, l, c, C, w, a, x, m, u, v, y, S = "sizzle" + 1 * new Date,
            _ = n.document,
            T = 0,
            i = 0,
            D = le(),
        ...
        try {
            O.apply(t = q.call(_.childNodes), _.childNodes), t[_.childNodes.length].nodeType
        } catch (e) {
            O = {
        ...
        function ae(t, e, n, i) {
            ...
            if (!i && ((e ? e.ownerDocument || e : _) !== w && C(e), e = e || w, x)) {
                if (11 !== d && (l = te.exec(t)))
                    if (o = l[1]) {
                        if (9 === d) {
                    ...
                    if (u = t, h = e, 1 === d && X.test(t)) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(oe, re) : e.setAttribute("id", a = S), r = (c = p(t)).length; r--;) c[r] = "#" + a + " " + _e(c[r]);
                        u = c.join(","), h = ne.test(t) && ve(e.parentNode) || e
                    }
                    try {
        ...
        for (e in f = ae.support = {}, s = ae.isXML = function (e) {
                ...
                return i !== w && 9 === i.nodeType && i.documentElement && (a = (w = i).documentElement, x = !s(w), _ !== w && (n = w.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", o, !1) : n.attachEvent && n.attachEvent("onunload", o)), f.attributes = ue(function (e) {
                    return e.className = "i", !e.getAttribute("className")
                }), f.getElementsByTagName = ue(function (e) {
                    return e.appendChild(w.createComment("")), !e.getElementsByTagName("*").length
                }), f.getElementsByClassName = ee.test(w.getElementsByClassName), f.getById = ue(function (e) {
                    return a.appendChild(e).id = S, !w.getElementsByName || !w.getElementsByName(S).length
                ...
                }, u = [], m = [], (f.qsa = ee.test(w.querySelectorAll)) && (ue(function (e) {
                    a.appendChild(e).innerHTML = "<a id='" + S + "'></a><select id='" + S + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && m.push("[*^$]=" + M + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || m.push("\\[" + M + "*(?:value|" + z + ")"), e.querySelectorAll("[id~=" + S + "-]").length || m.push("~="), e.querySelectorAll(":checked").length || m.push(":checked"), e.querySelectorAll("a#" + S + "+*").length || m.push(".#.+[+~]")
                }), ue(function (e) {
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !f.sortDetached && t.compareDocumentPosition(e) === n ? e === w || e.ownerDocument === _ && y(_, e) ? -1 : t === w || t.ownerDocument === _ && y(_, t) ? 1 : l ? H(l, e) - H(l, t) : 0 : 4 & n ? -1 : 1)
                } : function (e, t) {
                    if (e === t) return c = !0, 0;
                    var n, i = 0,
                        o = e.parentNode,
                        ...
                        s = [e],
                        a = [t];
                    if (!o || !r) return e === w ? -1 : t === w ? 1 : o ? -1 : r ? 1 : l ? H(l, e) - H(l, t) : 0;
                ...
                if ((e.ownerDocument || e) !== w && C(e), f.matchesSelector && x && !I[t + " "] && (!u || !u.test(t)) && (!m || !m.test(t))) try {
                    var n = v.call(e, t);
                ...
                var n = b.attrHandle[t.toLowerCase()],
                    i = n && L.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !x) : void 0;
                        ...
                        return 1 === g && 0 === m ? function (e) {
                            ...
                            if (u) {
                                ...
                                if (l = [y ? u.firstChild : u.lastChild], y && d) {
                                    for (f = (a = (i = (o = (r = (s = u)[S] || (s[S] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === T && i[1]) && i[2], s = a && u.childNodes[a]; s = ++a && s && s[c] || (f = a = 0) || l.pop();)
                                        if (1 === s.nodeType && ++f && s === e) {
                                            o[p] = [T, a, f];
                                            break
                                        }
                                } else if (d && (f = a = (i = (o = (r = (s = e)[S] || (s[S] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === T && i[1]), !1 === f)
                                    for (;
                                        (s = ++a && s && s[c] || (f = a = 0) || l.pop()) && ((_ ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++f || (d && ((o = (r = s[S] || (s[S] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] = [T, f]), s !== e)););
                ...
                pseudos: {
                    ...
                    lang: ce(function (n) {
                        return K.test(n || "") || ae.error("unsupported lang: " + n), n = n.replace(ie, h).toLowerCase(),
                            function (e) {
                                var t;
                                do {
        ...
        function we(f, p, g, m, v, e) {
            return m && !m[S] && (m = we(m)), v && !v[S] && (v = we(v, e)), ce(function (e, t, n, i) {
                var o, r, s, a = [],
                    l = [],
                    c = t.length,
                    u = e || function (e, t, n) {
                    ...
                    h = !f || !e && p ? u : Ce(u, a, f, n, i),
                    d = g ? v || (e ? f : c || m) ? [] : t : h;
                if (g && g(h, d, n, i), m)
                    for (o = Ce(d, l), m(o, [], n, i), r = o.length; r--;)(s = o[r]) && (d[l[r]] = !(h[l[r]] = s));
                if (e) {
                    if (v || f) {
                        if (v) {
                ...
                } else d = Ce(d === t ? d.splice(c, d.length) : d), v ? v(null, t, d, i) : O.apply(t, d)
            })
        }
        ...
        function xe(e) {
            for (var o, t, n, i = e.length, r = b.relative[e[0].type], s = r || b.relative[" "], a = r ? 1 : 0, l = be(function (e) {
                ...
                if (t = b.relative[e[a].type]) u = [be(Ee(u), t)];
                else {
                    if ((t = b.filter[e[a].type].apply(null, e[a].matches))[S]) {
                        for (n = ++a; n < i && !b.relative[e[n].type]; n++);
                        return we(1 < a && Ee(u), 1 < a && _e(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(U, "$1"), t, a < n && xe(e.slice(a, n)), n < i && xe(e = e.slice(n)), n < i && _e(e))
                    }
                    u.push(t)
                } return Ee(u)
        }
        ...
        function Se(m, v) {
            function e(e, t, n, i, o) {
                var r, s, a, l = 0,
                    ...
                    g = f.length;
                for (o && (E = t === w || t || o); c !== g && null != (r = f[c]); c++) {
                    if (_ && r) {
                        for (s = 0, t || r.ownerDocument === w || (C(r), n = !x); a = m[s++];)
                            if (a(r, t || w, n)) {
                                i.push(r);
                                break
                            } o && (T = p)
                ...
                if (l += c, y && c !== l) {
                    ...
                    O.apply(i, h), o && !e && 0 < h.length && 1 < l + v.length && ae.uniqueSort(i)
                }
                return o && (T = p, E = d), u
            }
            var y = 0 < v.length,
        ...
        return ye.prototype = b.filters = b.pseudos, b.setFilters = new ye, p = ae.tokenize = function (e, t) {
            ...
            for (s = e, a = [], l = b.preFilter; s;) {
                for (r in n && !(i = Q.exec(s)) || (i && (s = s.slice(i[0].length) || s), a.push(o = [])), n = !1, (i = $.exec(s)) && (n = i.shift(), o.push({
                        value: n,
                        type: i[0].replace(U, " ")
            ...
            var n, i = [],
                ...
                r = k[e + " "];
            if (!r) {
                for (n = (t = t || p(e)).length; n--;)(r = xe(t[n]))[S] ? i.push(r) : o.push(r);
            ...
            if (n = n || [], 1 === u.length) {
                if (2 < (r = u[0] = u[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === t.nodeType && x && b.relative[r[1].type]) {
                ...
                for (o = Y.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !b.relative[a = s.type]);)
                    if ((l = b.find[a]) && (i = l(s.matches[0].replace(ie, h), ne.test(r[0].type) && ve(t.parentNode) || t))) {
                        if (r.splice(o, 1), !(e = i.length && _e(r))) return O.apply(n, i), n;
                        break
                    }
            }
            return (c || d(e, u))(i, t, !x, n, !t || ne.test(e) && ve(t.parentNode) || t), n
        }, f.sortStable = S.split("").sort(N).join("") === S, f.detectDuplicates = !!c, C(), f.sortDetached = ue(function (e) {
    ...
    (S.fn.init = function (e, t, n) {
        var i, o;
        if (!e) return this;
        if (n = n || N, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : _(e) ? void 0 !== n.ready ? n.ready(e) : e(S) : S.makeArray(e, this);
        if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : L.exec(e)) || !i[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
        if (i[1]) {
            if (t = t instanceof S ? t[0] : t, S.merge(this, S.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : x, !0)), k.test(i[1]) && S.isPlainObject(t))
                for (i in t) _(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
            return this
        }
        return (o = x.getElementById(i[2])) && (this[0] = o, this.length = 1), this
    }).prototype = S.fn, N = S(x);
    ...
    S.fn.extend({
        ...
        S.fn[i] = function (e, t) {
            ...
            return "Until" !== i.slice(-5) && (t = e), t && "string" == typeof t && (n = S.filter(t, n)), 1 < this.length && (j[i] || S.uniqueSort(n), P.test(i) && n.reverse()), this.pushStack(n)
        }
    });
    var q = /[^\x20\t\r\n\f]+/g;
    ...
    function M(e, t, n, i) {
        var o;
        try {
            e && _(o = e.promise) ? o.call(e).done(t).fail(n) : e && _(o = e.then) ? o.call(e, t, n) : t.apply(void 0, [e].slice(i))
        } catch (e) {
            n.apply(void 0, [e])
        }
    }
    S.Callbacks = function (i) {
                ...
                add: function () {
                    return s && (e && !o && (l = s.length - 1, a.push(e)), function n(e) {
                        S.each(e, function (e, t) {
                            _(t) ? i.unique && c.has(t) || s.push(t) : t && t.length && "string" !== E(t) && n(t)
                        })
                            ...
                            return function () {
                                function e() {
                                    ...
                                    if (!(o < l)) {
                                        ...
                                        t = e && ("object" === _typeof(e) || "function" == typeof e) && e.then, _(t) ? a ? t.call(e, c(l, r, H, a), c(l, r, z, a)) : (l++, t.call(e, c(l, r, H, a), c(l, r, z, a), c(l, r, H, r.notifyWith))) : (s !== H && (n = void 0, i = [e]), (a || r.resolveWith)(n, i))
                                    }
                                }
                                var n = this,
                                    i = arguments,
                                    t = a ? e : function () {
                                        try {
                                            ...
                                            S.Deferred.exceptionHook && S.Deferred.exceptionHook(e, t.stackTrace), l <= o + 1 && (s !== z && (n = void 0, i = [e]), r.rejectWith(n, i))
                                        }
                                    };
                                o ? t() : (S.Deferred.getStackHook && (t.stackTrace = S.Deferred.getStackHook()), w.setTimeout(t))
                            }
                        }
                        return S.Deferred(function (e) {
                            r[0][3].add(c(0, e, _(i) ? i : H, e.notifyWith)), r[1][3].add(c(0, e, _(t) ? t : H)), r[2][3].add(c(0, e, _(n) ? n : z))
                        }).promise()
                    },
                    promise: function (e) {
        ...
        when: function (e) {
            ...
            var n = arguments.length,
                ...
                r = a.call(arguments),
                s = S.Deferred();
            if (n <= 1 && (M(e, s.done(t(i)).resolve, s.reject, !n), "pending" === s.state() || _(r[i] && r[i].then))) return s.then();
    ...
    S.Deferred.exceptionHook = function (e, t) {
        w.console && w.console.warn && e && F.test(e.name) && w.console.warn("jQuery.Deferred exception: " + e.message, e.stack, t)
    ...
    function W() {
        x.removeEventListener("DOMContentLoaded", W), w.removeEventListener("load", W), S.ready()
    }
    S.fn.ready = function (e) {
        ...
        readyWait: 1,
        ready: function (e) {
            (!0 === e ? --S.readyWait : S.isReady) || (S.isReady = !0) !== e && 0 < --S.readyWait || R.resolveWith(x, [S])
        }
    }), S.ready.then = R.then, "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? w.setTimeout(S.ready) : (x.addEventListener("DOMContentLoaded", W), w.addEventListener("load", W));
    ...
    function B(e, t, n, i, o, r, s) {
        ...
        else if (void 0 !== i && (o = !0, _(i) || (s = !0), c && (t = s ? (t.call(e, i), null) : (c = t, function (e, t, n) {
                return c.call(S(e), n)
            })), t))
    ...
    function he(e, t) {
        for (var n, i, o, r, s, a, l, c = [], u = 0, h = e.length; u < h; u++)(i = e[u]).style && (n = i.style.display, t ? ("none" === n && (c[u] = Y.get(i, "display") || null, c[u] || (i.style.display = "")), "" === i.style.display && le(i) && (c[u] = (l = s = r = void 0, s = (o = i).ownerDocument, a = o.nodeName, (l = ue[a]) || (r = s.body.appendChild(s.createElement(a)), l = S.css(r, "display"), r.parentNode.removeChild(r), "none" === l && (l = "block"), ue[a] = l)))) : "none" !== n && (c[u] = "none", Y.set(i, "display", n)));
    ...
    function Ee(e, t, n, i, o) {
        for (var r, s, a, l, c, u, h = t.createDocumentFragment(), d = [], f = 0, p = e.length; f < p; f++)
            if ((r = e[f]) || 0 === r)
                if ("object" === E(r)) S.merge(d, r.nodeType ? [r] : r);
                else if (be.test(r)) {
            for (s = s || h.appendChild(t.createElement("div")), a = (fe.exec(r) || ["", ""])[1].toLowerCase(), l = ge[a] || ge._default, s.innerHTML = l[1] + S.htmlPrefilter(r) + l[2], u = l[0]; u--;) s = s.lastChild;
            S.merge(d, s.childNodes), (s = h.firstChild).textContent = ""
        } else d.push(t.createTextNode(r));
        for (h.textContent = "", f = 0; r = d[f++];)
            if (i && -1 < S.inArray(r, i)) o && o.push(r);
            else if (c = re(r), s = me(h.appendChild(r), "script"), c && ve(s), n)
    ...
    function ke(e, o, r) {
        ...
        })) : void 0 === Y.get(e, o) && S.event.add(e, o, Se)
    }
    S.event = {
        global: {},
        add: function (t, e, n, i, o) {
            ...
            if (m)
                for (n.handler && (n = (r = n).handler, o = r.selector), o && S.find.matchesSelector(oe, o), n.guid || (n.guid = S.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                        return void 0 !== S && S.event.triggered !== e.type ? S.event.dispatch.apply(t, arguments) : void 0
                    }), c = (e = (e || "").match(q) || [""]).length; c--;) f = g = (a = xe.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), f && (h = S.event.special[f] || {}, f = (o ? h.delegateType : h.bindType) || f, h = S.event.special[f] || {}, u = S.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
        ...
        remove: function (e, t, n, i, o) {
            var r, s, a, l, c, u, h, d, f, p, g, m = Y.hasData(e) && Y.get(e);
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(q) || [""]).length; c--;)
                    if (f = g = (a = xe.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), f) {
                        for (h = S.event.special[f] || {}, d = l[f = (i ? h.delegateType : h.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = d.length; r--;) u = d[r], !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(r, 1), u.selector && d.delegateCount--, h.remove && h.remove.call(e, u));
                        s && !d.length && (h.teardown && !1 !== h.teardown.call(e, p, m.handle) || S.removeEvent(e, f, m.handle), delete l[f])
                    } else
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && A(t, "input") && ke(t, "click", Se), !1
                },
                trigger: function (e) {
                    var t = this || e;
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Se : Te, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && S.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[S.expando] = !0
    }, S.Event.prototype = {
        constructor: S.Event,
        ...
        which: function (e) {
            var t = e.button;
            return null == e.which && Ce.test(e.type) ? null != e.charCode ? e.charCode : e.keyCode : !e.which && void 0 !== t && we.test(e.type) ? 1 & t ? 1 : 2 & t ? 3 : 4 & t ? 2 : 0 : e.which
        }
        ...
        off: function (e, t, n) {
            ...
            if ("object" !== _typeof(e)) return !1 !== t && "function" != typeof t || (n = t, t = void 0), !1 === n && (n = Te), this.each(function () {
    ...
    function ze(n, i, o, r) {
        ...
        var e, t, s, a, l, c, u = 0,
            ...
            f = i[0],
            p = _(f);
        if (p || 1 < h && "string" == typeof f && !y.checkClone && Le.test(f)) return n.each(function (e) {
            var t = n.eq(e);
            p && (i[0] = f.call(this, e, t.html())), ze(t, i, o, r)
        });
        if (h && (t = (e = Ee(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === e.childNodes.length && (e = t), t || r)) {
            for (a = (s = S.map(me(e, "script"), Oe)).length; u < h; u++) l = e, u !== d && (l = S.clone(l, !0, !0), a && S.merge(s, me(l, "script"))), o.call(n[u], l, u);
            if (a)
                for (c = s[s.length - 1].ownerDocument, S.map(s, qe), u = 0; u < a; u++) l = s[u], pe.test(l.type || "") && !Y.access(l, "globalEval") && S.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? S._evalUrl && !l.noModule && S._evalUrl(l.src, {
                    nonce: l.nonce || l.getAttribute("nonce")
                }) : b(l.textContent.replace(Pe, ""), l, c))
        }
        return n
    }

    function Me(e, t, n) {
        for (var i, o = t ? S.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || S.cleanData(me(i)), i.parentNode && (n && re(i) && ve(me(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    S.extend({
    ...
    var Fe, Re, We, Be, Ue, Qe, $e, Xe = new RegExp("^(" + te + ")(?!px)[a-z%]+$", "i"),
        Ve = function (e) {
    ...
    function Ye() {
        if ($e) {
            Qe.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", $e.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", oe.appendChild(Qe).appendChild($e);
            var e = w.getComputedStyle($e);
            Fe = "1%" !== e.top, Ue = 12 === Ge(e.marginLeft), $e.style.right = "60%", Be = 36 === Ge(e.right), Re = 36 === Ge(e.width), $e.style.position = "absolute", We = 12 === Ge($e.offsetWidth / 3), oe.removeChild(Qe), $e = null
        }
    }
    ...
    function Je(e, t, n) {
        ...
        return (n = n || Ve(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || re(e) || (s = S.style(e, t)), !y.pixelBoxStyles() && Xe.test(s) && Ke.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    Qe = x.createElement("div"), ($e = x.createElement("div")).style && ($e.style.backgroundClip = "content-box", $e.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === $e.style.backgroundClip, S.extend(y, {
    ...
    S.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" === (r = _typeof(n)) && (o = ne.exec(n)) && o[1] && (n = ce(e, t, o), r = "number"), null != n && n == n && ("number" !== r || l || (n += o && o[3] || (S.cssNumber[a] ? "" : "px")), y.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function (e, t, n, i) {
            var o, r, s, a = X(t);
            return rt.test(t) || (t = it(a)), (s = S.cssHooks[t] || S.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Je(e, t, i)), "normal" === o && t in at && (o = at[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), S.each(["height", "width"], function (e, l) {
        S.cssHooks[l] = {
            get: function (e, t, n) {
                if (t) return !ot.test(S.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ut(e, l, n) : ae(e, st, function () {
                    return ut(e, l, n)
                })
            },
            set: function (e, t, n) {
        ...
        css: function (e, t) {
            return B(this, function (e, t, n) {
                var i, o, r = {},
                    s = 0;
                if (Array.isArray(t)) {
                    for (i = Ve(e), o = t.length; s < o; s++) r[t[s]] = S.css(e, t[s], !1, i);
                    return r
                }
                return void 0 !== n ? S.style(e, t, n) : S.css(e, t)
            }, e, t, 1 < arguments.length)
        }
    }), ((S.Tween = ht).prototype = {
        constructor: ht,
        ...
        run: function (e) {
            ...
            return this.options.duration ? this.pos = t = S.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : ht.propHooks._default.set(this), this
        }
        ...
        _default: "swing"
    }, S.fx = ht.prototype.init, S.fx.step = {};
    var dt, ft, pt, gt, mt = /^(?:toggle|show|hide)$/,
        vt = /queueHooks$/;

    function yt() {
        ft && (!1 === x.hidden && w.requestAnimationFrame ? w.requestAnimationFrame(yt) : w.setTimeout(yt, S.fx.interval), S.fx.tick())
    }
    ...
    function Ct(r, e, t) {
        var n, s, i = 0,
            ...
            l = function () {
                if (s) return !1;
                for (var e = dt || _t(), t = Math.max(0, c.startTime + c.duration - e), n = 1 - (t / c.duration || 0), i = 0, o = c.tweens.length; i < o; i++) c.tweens[i].run(n);
        ...
        for (! function (e, t) {
            ...
            if (n = Ct.prefilters[i].call(c, r, u, c.opts)) return _(n.stop) && (S._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
        return S.map(u, Et, c), _(c.opts.start) && c.opts.start.call(r, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), S.fx.timer(S.extend(l, {
            elem: r,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    S.Animation = S.extend(Ct, {
        ...
        tweener: function (e, t) {
            for (var n, i = 0, o = (e = _(e) ? (t = e, ["*"]) : e.match(q)).length; i < o; i++) n = e[i], Ct.tweeners[n] = Ct.tweeners[n] || [], Ct.tweeners[n].unshift(t)
        },
        prefilters: [function (e, t, n) {
            ...
            for (i in n.queue || (null == (s = S._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                ...
                for (i in h && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = Y.get(e, "display")), "none" === (u = S.css(e, "display")) && (c ? u = c : (he([e], !0), c = e.style.display || c, u = S.css(e, "display"), he([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === S.css(e, "float") && (l || (d.done(function () {
                        p.display = c
                    }), null == c && (u = p.display, c = "none" === u ? "" : u)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", d.always(function () {
                        p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
                    })), l = !1, f) l || (m ? "hidden" in m && (g = m.hidden) : m = Y.access(e, "fxshow", {
                    display: c
                }), r && (m.hidden = !g), g && he([e], !0), d.done(function () {
                    for (i in g || he([e]), Y.remove(e, "fxshow"), f) S.style(e, i, f[i])
    ...
    S.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? S.prop(e, t, n) : (1 === r && S.isXMLDoc(e) || (o = S.attrHooks[t.toLowerCase()] || (S.expr.match.bool.test(t) ? wt : void 0)), void 0 !== n ? null === n ? void S.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : null == (i = S.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
    ...
    S.fn.extend({
        ...
        toggleClass: function (o, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(o) : this.removeClass(o) : _(o) ? this.each(function (e) {
    ...
    S.fn.extend({
        val: function (n) {
            var i, e, o, t = this[0];
            return arguments.length ? (o = _(n), this.each(function (e) {
                var t;
            ...
            })) : t ? (i = S.valHooks[t.type] || S.valHooks[t.nodeName.toLowerCase()]) && "get" in i && void 0 !== (e = i.get(t, "value")) ? e : "string" == typeof (e = t.value) ? e.replace(It, "") : null == e ? "" : e : void 0
        }
    }), S.extend({
        valHooks: {
            option: {
    ...
    S.extend(S.event, {
        trigger: function (e, t, n, i) {
            var o, r, s, a, l, c, u, h, d = [n || x],
                f = v.call(e, "type") ? e.type : e,
                p = v.call(e, "namespace") ? e.namespace.split(".") : [];
            if (r = h = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !Lt.test(f + S.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), l = f.indexOf(":") < 0 && "on" + f, (e = e[S.expando] ? e : new S.Event(f, "object" === _typeof(e) && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : S.makeArray(t, [e]), u = S.event.special[f] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, t))) {
                if (!i && !u.noBubble && !g(n)) {
                    for (a = u.delegateType || f, Lt.test(a + f) || (r = r.parentNode); r; r = r.parentNode) d.push(r), s = r;
                    s === (n.ownerDocument || x) && d.push(s.defaultView || s.parentWindow || w)
                }
                for (o = 0;
                    (r = d[o++]) && !e.isPropagationStopped();) h = r, e.type = 1 < o ? a : u.bindType || f, (c = (Y.get(r, "events") || {})[e.type] && Y.get(r, "handle")) && c.apply(r, t), (c = l && r[l]) && c.apply && V(r) && (e.result = c.apply(r, t), !1 === e.result && e.preventDefault());
                return e.type = f, i || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(d.pop(), t) || !V(n) || l && _(n[f]) && !g(n) && ((s = n[l]) && (n[l] = null), S.event.triggered = f, e.isPropagationStopped() && h.addEventListener(f, Nt), n[f](), e.isPropagationStopped() && h.removeEventListener(f, Nt), S.event.triggered = void 0, s && (n[l] = s)), e.result
            }
        },
    ...
    function Ft(n, e, i, o) {
        ...
        if (Array.isArray(e)) S.each(e, function (e, t) {
            i || qt.test(n) ? o(n, t) : Ft(n + "[" + ("object" === _typeof(t) && null != t ? e : "") + "]", t, i, o)
        });
        else if (i || "object" !== E(e)) o(n, e);
        else
    ...
    S.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !S(this).is(":disabled") && Mt.test(this.nodeName) && !zt.test(e) && (this.checked || !de.test(e))
            }).map(function (e, t) {
                var n = S(this).val();
    ...
    Yt.href = Pt.href, S.extend({
        ...
        ajax: function (e, t) {
            ...
            var u, h, d, n, f, i, p, g, o, r, m = S.ajaxSetup({}, t),
                v = m.context || m,
                ...
                C = {
                    ...
                    getResponseHeader: function (e) {
                        ...
                        if (p) {
                            if (!n)
                                for (n = {}; t = Ut.exec(d);) n[t[1].toLowerCase() + " "] = (n[t[1].toLowerCase() + " "] || []).concat(t[2]);
                            t = n[e.toLowerCase() + " "]
                        }
            ...
            if (_.promise(C), m.url = ((e || m.url || Pt.href) + "").replace($t, Pt.protocol + "//"), m.type = t.method || t.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(q) || [""], null == m.crossDomain) {
                i = x.createElement("a");
                try {
            ...
            function c(e, t, n, i) {
                var o, r, s, a, l, c = t;
                p || (p = !0, f && w.clearTimeout(f), u = void 0, d = i || "", C.readyState = 0 < e ? 4 : 0, o = 200 <= e && e < 300 || 304 === e, n && (a = function (e, t, n) {
    ...
    S.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = _(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(rn, "$1" + i) : !1 !== e.jsonp && (e.url += (Ot.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
            return r || S.error(i + " was not called"), r[0]
        }, e.dataTypes[0] = "json", o = w[i], w[i] = function () {
            r = arguments
        }, n.always(function () {
            void 0 === o ? S(w).removeProp(i) : w[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, on.push(i)), r && _(o) && o(r[0]), r = o = void 0
        }), "script"
    }), y.createHTMLDocument = ((nn = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === nn.childNodes.length), S.parseHTML = function (e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (y.createHTMLDocument ? ((i = (t = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href, t.head.appendChild(i)) : t = x), r = !n && [], (o = k.exec(e)) ? [t.createElement(o[1])] : (o = Ee([e], t, r), r && r.length && S(r).remove(), S.merge([], o.childNodes)));
        var i, o, r
    }, S.fn.load = function (e, t, n) {
        var i, o, r, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = Dt(e.slice(a)), e = e.slice(0, a)), _(t) ? (n = t, t = void 0) : t && "object" === _typeof(t) && (o = "POST"), 0 < s.length && S.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            var i, o, r, s, a, l, c = S.css(e, "position"),
                u = S(e),
                h = {};
            "static" === c && (e.style.position = "relative"), a = u.offset(), r = S.css(e, "top"), l = S.css(e, "left"), o = ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (s = (i = u.position()).top, i.left) : (s = parseFloat(r) || 0, parseFloat(l) || 0), _(t) && (t = t.call(e, n, S.extend({}, a))), null != t.top && (h.top = t.top - a.top + s), null != t.left && (h.left = t.left - a.left + o), "using" in t ? t.using.call(e, h) : u.css(h)
        }
    }, S.fn.extend({
        offset: function (t) {
        ...
        var n, i, o;
        if ("string" == typeof t && (n = e[t], t = e, e = n), _(e)) return i = a.call(arguments, 2), (o = function () {
            return e.apply(t || this, i.concat(a.call(arguments)))
        }).guid = e.guid = e.guid || S.guid++, o
    }, S.holdReady = function (e) {
        e ? S.readyWait++ : S.ready(!0)
    }, S.isArray = Array.isArray, S.parseJSON = JSON.parse, S.nodeName = A, S.isFunction = _, S.isWindow = g, S.camelCase = X, S.type = E, S.now = Date.now, S.isNumeric = function (e) {
        var t = S.type(e);
    ...
    return S.noConflict = function (e) {
        return w.$ === S && (w.$ = an), e && w.jQuery === S && (w.jQuery = sn), S
    }, e || (w.jQuery = w.$ = S), S
}),
function (e, t) {
    "object" === ("undefined" == typeof exports ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? t(exports, require("jquery"), require("popper.js")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"], t) : t((e = e || self).bootstrap = {}, e.jQuery, e.Popper)
    ...
    var o = "alert",
        ...
        v = function () {
            ...
            return e.close = function (e) {
                ...
                var n = this;
                if (p(t).removeClass(m), p(t).hasClass(f)) {
    ...
    p(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', v._handleDismiss(new v)), p.fn[o] = v._jQueryInterface, p.fn[o].Constructor = v, p.fn[o].noConflict = function () {
    ...
    p(document).on(N.CLICK_DATA_API, T, function (e) {
        e.preventDefault();
        var t = e.target;
        p(t).hasClass(x) || (t = p(t).closest(I)), L._jQueryInterface.call(p(t), "toggle")
    ...
    var P = "carousel",
        ...
        U = {
            ...
            LOAD_DATA_API: "load" + O + q,
            CLICK_DATA_API: "click" + O + q
        },
        Q = "carousel",
        $ = "active",
        X = "slide",
        ...
        le = function () {
            ...
            return e.next = function () {
                ...
                p(this._element).off(O), p.removeData(this._element, j), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, e._getConfig = function (e) {
                return e = l({}, z, e), g.typeCheckConfig(P, e, M), e
                ...
                if (this._touchSupported) {
                    ...
                    p(this._element.querySelectorAll(ne)).on(U.DRAG_START, function (e) {
                        return e.preventDefault()
                    }), this._pointerEvent ? (p(this._element).on(U.POINTERDOWN, function (e) {
                        return n(e)
                    }), p(this._element).on(U.POINTERUP, function (e) {
                        return i(e)
                    }), this._element.classList.add(J)) : (p(this._element).on(U.TOUCHSTART, function (e) {
                        return n(e)
                ...
                if (o = e === F ? (n = K, i = Y, W) : (n = V, i = G, B), l && p(l).hasClass($)) this._isSliding = !1;
                else if (!this._triggerSlideEvent(l, o).isDefaultPrevented() && s && l) {
                    this._isSliding = !0, u && this.pause(), this._setActiveIndicatorElement(l);
                    var h = p.Event(U.SLID, {
                        relatedTarget: l,
                        direction: o,
                        from: a,
                        to: c
                    ...
                    if (p(this._element).hasClass(X)) {
                        ...
                        p(s).one(g.TRANSITION_END, function () {
                            p(l).removeClass(n + " " + i).addClass($), p(s).removeClass($ + " " + i + " " + n), r._isSliding = !1, setTimeout(function () {
                                return p(r._element).trigger(h)
                            }, 0)
                        }).emulateTransitionEnd(f)
                    } else p(s).removeClass($), p(l).addClass($), this._isSliding = !1, p(this._element).trigger(h);
                    u && this.cycle()
                }
    ...
    p(document).on(U.CLICK_DATA_API, re, le._dataApiClickHandler), p(window).on(U.LOAD_DATA_API, function () {
        for (var e = [].slice.call(document.querySelectorAll(se)), t = 0, n = e.length; t < n; t++) {
            var i = p(e[t]);
            le._jQueryInterface.call(i, i.data())
        }
    }), p.fn[P] = le._jQueryInterface, p.fn[P].Constructor = le, p.fn[P].noConflict = function () {
        return p.fn[P] = H, le._jQueryInterface
    };
    var ce = "collapse",
        ue = "bs.collapse",
        he = "." + ue,
        ...
        xe = function () {
            ...
            return e.toggle = function () {
                ...
                var e, t, n = this;
                if (!this._isTransitioning && !p(this._element).hasClass(me) && (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(Ce)).filter(function (e) {
                    ...
                    if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
                        ...
                        p(this._element).removeClass(ve).addClass(ye), this._element.style[o] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(_e).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var r = "scroll" + (o[0].toUpperCase() + o.slice(1)),
                            s = g.getTransitionDurationFromElement(this._element);
                        p(this._element).one(g.TRANSITION_END, function () {
                            p(n._element).removeClass(ye).addClass(ve).addClass(me), n._element.style[o] = "", n.setTransitioning(!1), p(n._element).trigger(ge.SHOWN)
                ...
                return (e = l({}, fe, e)).toggle = Boolean(e.toggle), g.typeCheckConfig(ce, e, pe), e
    ...
    }), p.fn[ce] = xe._jQueryInterface, p.fn[ce].Constructor = xe, p.fn[ce].noConflict = function () {
    ...
    var Se = "dropdown",
        ...
        Je = function () {
            ...
            return e.toggle = function () {
                    ...
                    if (c._clearMenus(), !t) {
                        ...
                        if (p(e).trigger(i), !i.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var o = this._element;
                                "parent" === this._config.reference ? o = e : g.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(e).addClass(ze), this._popper = new h(o, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === p(e).closest(We).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(Pe), p(e).toggleClass(Pe).trigger(p.Event(Ne.SHOWN, n))
                        }
                    }
                }
            }, e.show = function () {
                if (!(this._element.disabled || p(this._element).hasClass(Le) || p(this._menu).hasClass(Pe))) {
                    var e = {
                            relatedTarget: this._element
                        },
                        t = p.Event(Ne.SHOW, e),
                        n = c._getParentFromElement(this._element);
                    p(n).trigger(t), t.isDefaultPrevented() || (p(this._menu).toggleClass(Pe), p(n).toggleClass(Pe).trigger(p.Event(Ne.SHOWN, e)))
                }
            }, e.hide = function () {
                if (!this._element.disabled && !p(this._element).hasClass(Le) && p(this._menu).hasClass(Pe)) {
                    var e = {
                        ...
                        t = p.Event(Ne.HIDE, e),
                        n = c._getParentFromElement(this._element);
                    p(n).trigger(t), t.isDefaultPrevented() || (p(this._menu).toggleClass(Pe), p(n).toggleClass(Pe).trigger(p.Event(Ne.HIDDEN, e)))
                }
            }, e.dispose = function () {
                p.removeData(this._element, Te), p(this._element).off(De), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
            }, e.update = function () {
                ...
                return e = l({}, this.constructor.Default, p(this._element).data(), e), g.typeCheckConfig(Se, e, this.constructor.DefaultType), e
                ...
                var e = p(this._element.parentNode),
                    t = $e;
                return e.hasClass(je) ? (t = Ue, p(this._menu).hasClass(He) && (t = Qe)) : e.hasClass(Oe) ? t = Ve : e.hasClass(qe) ? t = Ke : p(this._menu).hasClass(He) && (t = Xe), t
                ...
                return this.each(function () {
                    ...
                    if (e || (e = new c(this, t), p(this).data(Te, e)), "string" == typeof n) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n]()
                    }
                })
                ...
                if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                    for (var t = [].slice.call(document.querySelectorAll(Me)), n = 0, i = t.length; n < i; n++) {
                        ...
                        if (e && "click" === e.type && (s.clickEvent = e), r) {
                            var a = r._menu;
                            if (p(o).hasClass(Pe) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(o, e.target))) {
                                var l = p.Event(Ne.HIDE, s);
                                p(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[n].setAttribute("aria-expanded", "false"), p(a).removeClass(Pe), p(o).removeClass(Pe).trigger(p.Event(Ne.HIDDEN, s)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(Re).length)) : Ie.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(Le))) {
                    var t = c._getParentFromElement(this),
                        n = p(t).hasClass(Pe);
                    if (n && (!n || 27 !== e.which && 32 !== e.which)) {
                        var i = [].slice.call(t.querySelectorAll(Be));
                        if (0 !== i.length) {
    ...
    p(document).on(Ne.KEYDOWN_DATA_API, Me, Je._dataApiKeydownHandler).on(Ne.KEYDOWN_DATA_API, Re, Je._dataApiKeydownHandler).on(Ne.CLICK_DATA_API + " " + Ne.KEYUP_DATA_API, Je._clearMenus).on(Ne.CLICK_DATA_API, Me, function (e) {
        e.preventDefault(), e.stopPropagation(), Je._jQueryInterface.call(p(this), "toggle")
    }).on(Ne.CLICK_DATA_API, Fe, function (e) {
        e.stopPropagation()
    }), p.fn[Se] = Je._jQueryInterface, p.fn[Se].Constructor = Je, p.fn[Se].noConflict = function () {
        return p.fn[Se] = ke, Je._jQueryInterface
    };
    var Ze = "modal",
        et = "bs.modal",
        tt = "." + et,
        ...
        yt = function () {
            ...
            return e.toggle = function (e) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    p(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(rt.CLICK_DISMISS, gt, function (e) {
                        return t.hide(e)
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (p(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        ...
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(rt.FOCUSIN), p(this._element).removeClass(ht), p(this._element).off(rt.CLICK_DISMISS), p(this._dialog).off(rt.MOUSEDOWN_DISMISS), i) {
                ...
                [window, this._element, this._dialog].forEach(function (e) {
                    return p(e).off(tt)
                }), p(document).off(rt.FOCUSIN), p.removeData(this._element, et), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
                ...
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function () {
                    p(document.body).removeClass(ct), e._resetAdjustments(), e._resetScrollbar(), p(e._element).trigger(rt.HIDDEN)
                })
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = lt, n && this._backdrop.classList.add(n), p(this._backdrop).appendTo(document.body), p(this._element).on(rt.CLICK_DISMISS, function (e) {
                ...
                return this.each(function () {
                    var e = p(this).data(et),
                        t = l({}, it, p(this).data(), "object" === _typeof(n) && n ? n : {});
                    if (e || (e = new o(this, t), p(this).data(et, e)), "string" == typeof n) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n](i)
    ...
    p(document).on(rt.CLICK_DATA_API, pt, function (e) {
        var t, n = this,
            i = g.getSelectorFromElement(this);
        i && (t = document.querySelector(i));
        var o = p(t).data(et) ? "toggle" : l({}, p(t).data(), p(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
        var r = p(t).one(rt.SHOW, function (e) {
            e.isDefaultPrevented() || r.one(rt.HIDDEN, function () {
                p(n).is(":visible") && n.focus()
            })
        });
        yt._jQueryInterface.call(p(t), o, this)
        ...
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), s = Object.keys(r), a = [].slice.call(n.body.querySelectorAll("*")), i = function (e) {
                ...
                i.forEach(function (e) {
                    ! function (e, t) {
                        ...
                        if (-1 !== t.indexOf(n)) return -1 === _t.indexOf(n) || Boolean(e.nodeValue.match(Et) || e.nodeValue.match(Ct));
        ...
        Qt = function () {
            ...
            return e.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && p(o).addClass(Ht);
                    var s = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
                        a = this._getAttachment(s);
                    this.addAttachmentClass(a);
                    var l = this._getContainer();
                    p(o).data(this.constructor.DATA_KEY, this), p.contains(this.element.ownerDocument.documentElement, this.tip) || p(o).appendTo(l), p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new h(this.element, o, {
                        placement: a,
                        modifiers: {
                            offset: this._getOffset(),
                            flip: {
                    ...
                    }), p(o).addClass(zt), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                    var c = function () {
                        t.config.animation && t._fixTransition();
                        var e = t._hoverState;
                        t._hoverState = null, p(t.element).trigger(t.constructor.Event.SHOWN), e === Ot && t._leave(null, t)
                    };
                    if (p(this.tip).hasClass(Ht)) {
                ...
                if (p(this.element).trigger(o), !o.isDefaultPrevented()) {
                    if (p(i).removeClass(zt), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[Bt] = !1, this._activeTrigger[Wt] = !1, this._activeTrigger[Rt] = !1, p(this.tip).hasClass(Ht)) {
                ...
                this.setElementContent(p(e.querySelectorAll(Mt)), this.getTitle()), p(e).removeClass(Ht + " " + zt)
            }, e.setElementContent = function (e, t) {
                "object" !== _typeof(t) || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = wt(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t)) : e.text(t) : this.config.html ? p(t).parent().is(e) || e.empty().append(t) : e.text(p(t).text())
            }, e.getTitle = function () {
                ...
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusin" === e.type ? Wt : Rt] = !0), p(t.getTipElement()).hasClass(zt) || t._hoverState === jt ? t._hoverState = jt : (clearTimeout(t._timeout), t._hoverState = jt, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function () {
                    t._hoverState === jt && t.show()
                }, t.config.delay.show) : t.show())
            }, e._leave = function (e, t) {
                var n = this.constructor.DATA_KEY;
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? Wt : Rt] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = Ot, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
                ...
                return Object.keys(t).forEach(function (e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), g.typeCheckConfig(xt, e, this.constructor.DefaultType), e.sanitize && (e.template = wt(e.template, e.whiteList, e.sanitizeFn)), e
                ...
                null === e.getAttribute("x-placement") && (p(e).removeClass(Ht), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
            }, i._jQueryInterface = function (n) {
                return this.each(function () {
    ...
    p.fn[xt] = Qt._jQueryInterface, p.fn[xt].Constructor = Qt, p.fn[xt].noConflict = function () {
        return p.fn[xt] = Dt, Qt._jQueryInterface
    };
    var $t = "popover",
        Xt = "bs.popover",
        Vt = "." + Xt,
    ...
    p.fn[$t] = sn._jQueryInterface, p.fn[$t].Constructor = sn, p.fn[$t].noConflict = function () {
        return p.fn[$t] = Kt, sn._jQueryInterface
    };
    var an = "scrollspy",
        ln = "bs.scrollspy",
        cn = "." + ln,
        ...
        Tn = function () {
            function i(e, t) {
                var n = this;
                this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(t), this._selector = this._config.target + " " + yn + "," + this._config.target + " " + bn + "," + this._config.target + " " + Cn, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(fn.SCROLL, function (e) {
                    return n._process(e)
            ...
            return e.refresh = function () {
                var t = this,
                    e = this._scrollElement === this._scrollElement.window ? xn : Sn,
                ...
                if ("string" != typeof (e = l({}, hn, "object" === _typeof(e) && e ? e : {})).target) {
                ...
                n.hasClass(pn) ? (n.closest(En).find(wn).addClass(gn), n.addClass(gn)) : (n.addClass(gn), n.parents(vn).prev(yn + ", " + bn).addClass(gn), n.parents(vn).prev(_n).children(yn).addClass(gn)), p(this._scrollElement).trigger(fn.ACTIVATE, {
                    relatedTarget: t
                })
            }, e._clear = function () {
                ...
                return this.each(function () {
                    var e = p(this).data(ln),
                        t = "object" === _typeof(n) && n;
                    if (e || (e = new i(this, t), p(this).data(ln, e)), "string" == typeof n) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n]()
                    }
                })
    ...
    }), p.fn[an] = Tn._jQueryInterface, p.fn[an].Constructor = Tn, p.fn[an].noConflict = function () {
        return p.fn[an] = un, Tn._jQueryInterface
    };
    var Dn = "bs.tab",
        An = "." + Dn,
        kn = p.fn.tab,
        ...
        zn = ".active",
        Mn = "> li > .active",
        Fn = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]',
        Rn = ".dropdown-toggle",
        ...
        Bn = function () {
            ...
            return e.show = function () {
                var n = this;
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Ln) || p(this._element).hasClass(Pn))) {
                    var e, i, t = p(this._element).closest(Hn)[0],
                        o = g.getSelectorFromElement(this._element);
                    if (t) {
                        var r = "UL" === t.nodeName || "OL" === t.nodeName ? Mn : zn;
                ...
                var o = this,
                    r = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(zn) : p(t).find(Mn))[0],
                    s = n && r && p(r).hasClass(jn);
                if (r && s) {
                    var a = g.getTransitionDurationFromElement(r);
                    p(r).removeClass(On).one(g.TRANSITION_END, i).emulateTransitionEnd(a)
                } else i()
            }, e._transitionComplete = function (e, t, n) {
                if (t) {
                    p(t).removeClass(Ln);
                    var i = p(t.parentNode).find(Wn)[0];
                    i && p(i).removeClass(Ln), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
                }
                if (p(e).addClass(Ln), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), g.reflow(e), e.classList.contains(jn) && e.classList.add(On), e.parentNode && p(e.parentNode).hasClass(Nn)) {
                    var o = p(e).closest(qn)[0];
                    if (o) {
    ...
    p(document).on(In.CLICK_DATA_API, Fn, function (e) {
        e.preventDefault(), Bn._jQueryInterface.call(p(this), "show")
    }), p.fn.tab = Bn._jQueryInterface, p.fn.tab.Constructor = Bn, p.fn.tab.noConflict = function () {
        return p.fn.tab = kn, Bn._jQueryInterface
    };
    var Un = "toast",
        Qn = "bs.toast",
        $n = "." + Qn,
        ...
        ni = function () {
            ...
            return e.show = function () {
                var e = this;
                p(this._element).trigger(Vn.SHOW), this._config.animation && this._element.classList.add(Kn);

                function t() {
                    e._element.classList.remove(Jn), e._element.classList.add(Gn), p(e._element).trigger(Vn.SHOWN), e._config.autohide && e.hide()
                }
                ...
                var t = this;
                this._element.classList.contains(Gn) && (p(this._element).trigger(Vn.HIDE), e ? this._close() : this._timeout = setTimeout(function () {
                    t._close()
                }, this._config.delay))
            }, e.dispose = function () {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Gn) && this._element.classList.remove(Gn), p(this._element).off(Vn.CLICK_DISMISS), p.removeData(this._element, Qn), this._element = null, this._config = null
            }, e._getConfig = function (e) {
                return e = l({}, ei, p(this._element).data(), "object" === _typeof(e) && e ? e : {}), g.typeCheckConfig(Un, e, this.constructor.DefaultType), e
            }, e._setListeners = function () {
                var e = this;
                p(this._element).on(Vn.CLICK_DISMISS, ti, function () {
                    return e.hide(!0)
                })
            }, e._close = function () {
                function e() {
                    t._element.classList.add(Yn), p(t._element).trigger(Vn.HIDDEN)
                }
                var t = this;
                ...
                return this.each(function () {
                    ...
                    if (t || (t = new o(this, n), e.data(Qn, t)), "string" == typeof i) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i](this)
                    }
                })
    ...
    p.fn[Un] = ni._jQueryInterface, p.fn[Un].Constructor = ni, p.fn[Un].noConflict = function () {
            return p.fn[Un] = Xn, ni._jQueryInterface
        },
        function () {
            if (void 0 === p) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
            var e = p.fn.jquery.split(" ")[0].split(".");
            if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || 4 <= e[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }(), e.Util = g, e.Alert = v, e.Button = L, e.Carousel = le, e.Collapse = xe, e.Dropdown = Je, e.Modal = yt, e.Popover = sn, e.Scrollspy = Tn, e.Tab = Bn, e.Toast = ni, e.Tooltip = Qt, Object.defineProperty(e, "__esModule", {
            value: !0
        })
}),
function (e, t) {
    "object" === ("undefined" == typeof exports ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).Headroom = t()
}(void 0, function () {
    function e() {
    ...
    function n(e, i, o) {
        ...
        function c() {
            var e = Math.round(s.scrollY()),
                t = s.height(),
                n = s.scrollHeight();
            l.scrollY = e, l.lastScrollY = a, l.direction = a < e ? "down" : "up", l.distance = Math.abs(e - a), l.isOutOfBounds = e < 0 || n < e + t, l.top = e <= i.offset, l.bottom = n <= e + t, l.toleranceExceeded = l.distance > i.tolerance[l.direction], o(l), a = e, r = !1
        }

        function u() {
            r || (r = !0, t = requestAnimationFrame(c))
        }
        var h = !!n && {
            passive: !0,
            capture: !1
        };
        return e.addEventListener("scroll", u, h), {
            destroy: function () {
                cancelAnimationFrame(t), e.removeEventListener("scroll", u, h)
            }
        }
    }

    function i(e, t) {
        t = t || {}, Object.assign(this, i.options, t), this.classes = Object.assign({}, i.options.classes, t.classes), this.elem = e, this.tolerance = function (e) {
            return e === Object(e) ? e : {
                down: e,
                up: e
            }
    ...
    return i.prototype = {
        constructor: i,
        init: function () {
            return i.cutsTheMustard && !this.initialised && (this.addClass("initial"), this.initialised = !0, setTimeout(function (e) {
    ...
    }, i.cutsTheMustard = !!(e() && function () {}.bind && "classList" in document.documentElement && Object.assign && Object.keys && requestAnimationFrame), i
}),
function (t, n) {
    "function" == typeof define && define.amd ? define("jquery-bridget/jquery-bridget", ["jquery"], function (e) {
        return n(t, e)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = n(t, require("jquery")) : t.jQueryBridget = n(t, t.jQuery)
}(window, function (e, t) {
    ...
    function o(c, o, u) {
        (u = u || t || e.jQuery) && (o.prototype.option || (o.prototype.option = function (e) {
            ...
            }(this, e, n.call(arguments, 1)) : (function (e, i) {
                e.each(function (e, t) {
                    var n = u.data(t, c);
...
function (e, t) {
    "function" == typeof define && define.amd ? define("get-size/get-size", t) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = t() : e.getSize = t()
}(window, function () {
    function v(e) {
        var t = parseFloat(e);
    ...
    function w(e) {
        if (! function () {
                if (!C) {
                    ...
                    t.appendChild(e);
                    var n = b(e);
                    E = 200 == Math.round(v(n.width)), w.isBoxSizeOuter = E, t.removeChild(e)
                }
            ...
            for (var i = n.isBorderBox = "border-box" == t.boxSizing, o = 0; o < _; o++) {
                var r = y[o],
                    s = t[r],
                    a = parseFloat(s);
                n[r] = isNaN(a) ? 0 : a
            ...
            var m = v(t.height);
            return !1 !== m && (n.height = m + (p ? 0 : c + f)), n.innerWidth = n.width - (l + d), n.innerHeight = n.height - (c + f), n.outerWidth = n.width + u, n.outerHeight = n.height + h, n
        }
    }
    return w
}),
...
function (t, n) {
    "function" == typeof define && define.amd ? define("fizzy-ui-utils/utils", ["desandro-matches-selector/matches-selector"], function (e) {
        return n(t, e)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = n(t, require("desandro-matches-selector")) : t.fizzyUIUtils = n(t, t.matchesSelector)
}(window, function (c, r) {
    var u = {
            extend: function (e, t) {
    ...
    u.makeArray = function (e) {
        return Array.isArray(e) ? e : null == e ? [] : "object" == _typeof(e) && "number" == typeof e.length ? t.call(e) : [e]
...
function (t, n) {
    "function" == typeof define && define.amd ? define("flickity/js/cell", ["get-size/get-size"], function (e) {
        return n(t, e)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = n(t, require("get-size")) : (t.Flickity = t.Flickity || {}, t.Flickity.Cell = n(t, t.getSize))
}(window, function (e, t) {
    function n(e, t) {
...
function (t, n) {
    "function" == typeof define && define.amd ? define("flickity/js/animate", ["fizzy-ui-utils/utils"], function (e) {
        return n(t, e)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = n(t, require("fizzy-ui-utils")) : (t.Flickity = t.Flickity || {}, t.Flickity.animatePrototype = n(t, t.fizzyUIUtils))
}(window, function (e, t) {
    var n = {
...
function (s, a) {
    if ("function" == typeof define && define.amd) define("flickity/js/flickity", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./slide", "./animate"], function (e, t, n, i, o, r) {
        return a(s, e, t, n, i, o, r)
    });
    else if ("object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports) module.exports = a(s, require("ev-emitter"), require("get-size"), require("fizzy-ui-utils"), require("./cell"), require("./slide"), require("./animate"));
    else {
        var e = s.Flickity;
        s.Flickity = a(s, s.EvEmitter, s.getSize, s.fizzyUIUtils, e.Cell, e.Slide, e.animatePrototype)
    }
}(window, function (i, e, t, a, n, s, o) {
    var l = i.jQuery,
    ...
    return p.setCellAlign = function () {
        ...
        this.deactivate(), i.removeEventListener("resize", this), this.allOff(), this.emitEvent("destroy"), l && this.$element && l.removeData(this.element, "flickity"), delete this.element.flickityGUID, delete d[this.guid]
        ...
        l = e
    }, f.Cell = n, f.Slide = s, f
}),
function (t, n) {
    "function" == typeof define && define.amd ? define("unipointer/unipointer", ["ev-emitter/ev-emitter"], function (e) {
        return n(t, e)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = n(t, require("ev-emitter")) : t.Unipointer = n(t, t.EvEmitter)
}(window, function (o, e) {
    function t() {}
...
function (t, n) {
    "function" == typeof define && define.amd ? define("unidragger/unidragger", ["unipointer/unipointer"], function (e) {
        return n(t, e)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = n(t, require("unipointer")) : t.Unidragger = n(t, t.Unipointer)
}(window, function (r, e) {
    function t() {}
    var n = t.prototype = Object.create(e.prototype);
...
function (i, o) {
    "function" == typeof define && define.amd ? define("flickity/js/drag", ["./flickity", "unidragger/unidragger", "fizzy-ui-utils/utils"], function (e, t, n) {
        return o(i, e, t, n)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = o(i, require("./flickity"), require("unidragger"), require("fizzy-ui-utils")) : i.Flickity = o(i, i.Flickity, i.Unidragger, i.fizzyUIUtils)
    ...
    i._createDrag = function () {
        this.on("activate", this.onActivateDrag), this.on("uiChange", this._uiChangeDrag), this.on("deactivate", this.onDeactivateDrag), this.on("cellChange", this.updateDraggable), o && !r && (n.addEventListener("touchmove", function () {}), r = !0)
...
function (i, o) {
    "function" == typeof define && define.amd ? define("flickity/js/prev-next-button", ["./flickity", "unipointer/unipointer", "fizzy-ui-utils/utils"], function (e, t, n) {
        return o(i, e, t, n)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = o(i, require("./flickity"), require("unipointer"), require("fizzy-ui-utils")) : o(i, i.Flickity, i.Unipointer, i.fizzyUIUtils)
...
function (e, i) {
    "function" == typeof define && define.amd ? define("flickity/js/player", ["ev-emitter/ev-emitter", "fizzy-ui-utils/utils", "./flickity"], function (e, t, n) {
        return i(e, t, n)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = i(require("ev-emitter"), require("fizzy-ui-utils"), require("./flickity")) : i(e.EvEmitter, e.fizzyUIUtils, e.Flickity)
...
function (n, i) {
    "function" == typeof define && define.amd ? define("flickity/js/add-remove-cell", ["./flickity", "fizzy-ui-utils/utils"], function (e, t) {
        return i(n, e, t)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = i(n, require("./flickity"), require("fizzy-ui-utils")) : i(n, n.Flickity, n.fizzyUIUtils)
...
function (t, n) {
    "function" == typeof define && define.amd ? define("imagesloaded/imagesloaded", ["ev-emitter/ev-emitter"], function (e) {
        return n(t, e)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = n(t, require("ev-emitter")) : t.imagesLoaded = n(t, t.EvEmitter)
    ...
    function l(e, t, n) {
        ...
        "string" == typeof e && (i = document.querySelectorAll(e)), i ? (this.elements = function (e) {
            return Array.isArray(e) ? e : "object" == _typeof(e) && "number" == typeof e.length ? a.call(e) : [e]
...
function (n, i) {
    "function" == typeof define && define.amd ? define(["flickity/js/index", "imagesloaded/imagesloaded"], function (e, t) {
        return i(n, e, t)
    }) : "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = i(n, require("flickity"), require("imagesloaded")) : n.Flickity = i(n, n.Flickity, n.imagesLoaded)
}(window, function (e, t, n) {
    ...
    return i._createImagesLoaded = function () {
        ...
        if (this.options.imagesLoaded) {
            var i = this;
            n(this.slider).on("progress", function (e, t) {
    ...
    t(".main-nav-toggler").on("click", function () {
        t("body").toggleClass("show-nav")
    });
    var e = t(".main-navigation").outerHeight();
    t("body").css("padding-top", e), t(".main-navigation-menu.for-mobile a.dropdown-toggle").on("click", function (e) {
        e.preventDefault(), t(this).parent("li").toggleClass("show-dropdown")
    }), t(".custom-logo-link img").removeAttr("width").removeAttr("height"), new Headroom(t(".main-navigation")[0]).init({
        tolerance: {
            up: 500,
            down: 0
        }
    ...
    e(".related-posts-section .items").flickity({
        cellAlign: "left",
        groupCells: !0,
        pageDots: !1,
        contain: !0
    ...
    c("button.custom-load-more-posts-btn").on("click", function (e) {
        e.preventDefault();
        var t = c(this);
        t.attr("disabled", !0), t.addClass("loading-state");
        var n = t.text();
        t.text("Loading");
        var i = t.attr("data-page"),
            o = c(this).data("posttype"),
            r = c(this).data("posts_per_page"),
            s = t.data("ajax-url"),
            a = t.data("container"),
            l = t.data("nonce");
        c.ajax({
            ...
            success: function (e) {
                console.log(e), e && 6 < e.length ? (c("." + a).append(e), t.attr("data-page", parseInt(i) + 1), t.text(n), t.attr("disabled", !1)) : t.remove()
            }
        })
    })
