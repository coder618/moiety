 ...
 * 
 * Licence purchased  by : iamahadul@gmail.com
 */
...
jQuery(document).ready(function ($) {
  ...
  $("body").css("padding-top", navar_height); // mobile dropdown toggle

  $(".main-navigation-menu.for-mobile a.dropdown-toggle").on("click", function (e) {
    e.preventDefault();
    $(this).parent("li").toggleClass("show-dropdown");
  });
  /** Remove height width parameter  in  wordpress given custom logo  */

  $(".custom-logo-link img").removeAttr("width").removeAttr("height"); // Headroom INIT
...
jQuery(document).ready(function ($) {
  $(".related-posts-section .items").flickity({
    // options
    cellAlign: "left",
    groupCells: true,
    pageDots: false,
...
jQuery(document).ready(function ($) {
  $("button.custom-load-more-posts-btn").on("click", function (e) {
    e.preventDefault();
    var $this = $(this);
    ...
    $.ajax({
      ...
      data: {
        ...
        nonce: nonce,
        action: "custom_render_posts_ajax_loadmore"
      },
      ...
      success: function (response) {
        ...
        if (response && response.length > 6) {
          ...
          $("." + posts_container).append(response); // Change the buttons attributes for next request
